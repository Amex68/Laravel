  ...
  <form @submit.prevent="create">
    <div class="grid grid-cols-6 gap-4">
      <div class="col-span-2">
        ...
        <div v-if="form.errors.beds" class="ïnput-error">
          {{ form.errors.beds }}
        </div>
      </div>
      ...
      <div class="col-span-2">
        ...
        <div v-if="form.errors.baths" class="ïnput-error">
          {{ form.errors.baths }}
        </div>
      </div>
      ...
      <div class="col-span-2">
        ...
        <div v-if="form.errors.area" class="ïnput-error">
          {{ form.errors.area }}
        </div>
      </div>
      ...
      <div class="col-span-4">
        ...
        <div v-if="form.errors.city" class="ïnput-error">
          {{ form.errors.city }}
        </div>
      </div>
      ...
      <div class="col-span-2">
        ...
        <div v-if="form.errors.code" class="ïnput-error">
          {{ form.errors.code }}
        </div>
      </div>
      ...
      <div class="col-span-4">
        ...
        <div v-if="form.errors.street" class="ïnput-error">
          {{ form.errors.street }}
        </div>
      </div>
      ...
      <div class="col-span-2">
        ...
        <div v-if="form.errors.street_nr" class="ïnput-error">
      ...
      <div class="col-span-6">
        ...
        <div v-if="form.errors.price" class="ïnput-error">
          {{ form.errors.price }}
        </div>
      </div>
